...
# ctlars
The CTLARS Algorithm: Complex early-terminated Forward Variable Selection

It computes the solution path of the complex Terminating-LARS (CTLARS) algorithm.
The CTLARS algorithm appends dummy predictors to the original predictor matrix
